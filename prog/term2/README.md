...
6.  **Code Golf**
    ...
    4.  Подача решений через [чат](https://t.me/joinchat/9CEJ87GS1602Y2Ey). Решение должно быть корректно отформатировано и начинаться с `;Solution номинация длина`. Например, `;Solution det 1000`.
